...
<head>
    ...
    <title><%= (String)request.getAttribute("appName") %> - <%= com.smartcalendar.utils.LanguageUtil.getText(lang, "dashboard.businessAdmin") %></title>
...
<div class="dashboard-container">
    ...
    <v:pagination currentPage="${page}" totalPages="${totalPages}" basePath="business-admin" size="${size}" query="${searchQuery != null ? searchQuery : ''}" />
