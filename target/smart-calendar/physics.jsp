...
<head>
    ...
    <title><%= com.smartcalendar.utils.LanguageUtil.getText(lang, "college.physics.title") %></title>
...
<body>
    ...
    <div class="form-container">
        <div class="form-header">
            <div>
                <h2 class="page-title">🏫 <%= com.smartcalendar.utils.LanguageUtil.getText(lang, "college.physics.title") %></h2>
                <div class="page-sub"><%= com.smartcalendar.utils.LanguageUtil.getText(lang, "college.physics.subtitle") %></div>
            </div>
        </div>
        ...
        <div class="card">
            ...
            <div class="teacher-list">
                <div class="teacher" data-teacher="蒙晓云 MENG XIAO YUAN">
                    <div class="kv"><b><%= com.smartcalendar.utils.LanguageUtil.getText(lang, "admin.colleges.teacher.name") %></b><span>蒙晓云 MENG XIAO YUAN</span></div>
                    <div class="kv"><b><%= com.smartcalendar.utils.LanguageUtil.getText(lang, "admin.colleges.address") %></b><span>Building 20, Room 311</span></div>
                    <div class="kv"><b><%= com.smartcalendar.utils.LanguageUtil.getText(lang, "admin.colleges.phone") %></b><span><a href="tel:+8657982298268">0579–82298268</a></span></div>
                </div>
            </div>
            <div class="card-footer">
                <div class="actions-bar">
                    ...
                    <a href="https://j.map.baidu.com/29/8FPk" target="_blank" rel="noopener noreferrer" class="btn btn-primary btn-icon">📍 <span><%= com.smartcalendar.utils.LanguageUtil.getText(lang, "common.goLocation") %></span></a>
                </div>
            </div>
        </div>
    </div>
